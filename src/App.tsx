...
function App() {
    ...
    const [MegacreditProduction, setMegacreditProduction] = useState(
        loadResource("MegacreditProduction")
    )
    const [Steel, setSteel] = useState(loadResource("Steel"))
    const [SteelProduction, setSteelProduction] = useState(
        loadResource("SteelProduction")
    )
    const [Titan, setTitan] = useState(loadResource("Titan"))
    const [TitanProduction, setTitanProduction] = useState(
        loadResource("TitanProduction")
    )
    const [Herb, setHerb] = useState(loadResource("Herb"))
    const [HerbProduction, setHerbProduction] = useState(
        loadResource("HerbProduction")
    )
    const [Energy, setEnergy] = useState(loadResource("Energy"))
    const [EnergyProduction, setEnergyProduction] = useState(
        loadResource("EnergyProduction")
    )
    const [Heat, setHeat] = useState(loadResource("Heat"))
    const [HeatProduction, setHeatProduction] = useState(
        loadResource("HeatProduction")
    )
